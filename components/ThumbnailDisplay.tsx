...
const ThumbnailDisplay: React.FC<ThumbnailDisplayProps> = ({ image, isLoading, error, analysis }) => {
            ...
            <div className="mt-4 p-4 bg-glass-bg border border-glass-border rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-brand-text-secondary leading-relaxed">{analysis}</p>
                </div>
              </div>
            </div>
          )}
